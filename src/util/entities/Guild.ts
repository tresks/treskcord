...
export class Guild extends BaseClass {
	...
	@Column({ default: 0 })
	premium_tier: number = 0; // crowd premium level
	...
	@Column({ default: 4 })
	system_channel_flags: number = 4;

	@Column({ default: false })
	unavailable: boolean = false;

	@Column({ default: 0 })
	verification_level: number = 0;
	...
	@Column({ default: 25 })
	max_stage_video_channel_users: number = 25;
